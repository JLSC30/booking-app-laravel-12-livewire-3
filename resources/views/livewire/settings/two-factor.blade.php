            ...
            @if ($twoFactorEnabled)
                <div class="space-y-4">
                    <div class="flex items-center gap-3">
                        ...
                        <x-mary-badge value="{{ __('Enabled') }}" class="badge-success badge-soft" />
                    </div>
                    ...
                    <div class="flex justify-start">
                        ...
                        <x-mary-button class="btn-error btn-outline" icon="o-shield-exclamation" wire:click="disable">
                            {{ __('Disable 2FA') }}
                        </x-mary-button>
                    </div>
                </div>
            @else
                <div class="space-y-4">
                    <div class="flex items-center gap-3">
                        ...
                        <x-mary-badge value="{{ __('Disabled') }}" class="badge-error badge-soft" />
                    </div>

                    <flux:text variant="subtle">
                        {{ __('When you enable two-factor authentication, you will be prompted for a secure pin during login. This pin can be retrieved from a TOTP-supported application on your phone.') }}
                    </flux:text>
                    <x-mary-button type="submit" icon="o-shield-check" class="btn-neutral dark:btn-secondary"
    ...
    <flux:modal name="two-factor-setup-modal" class="max-w-md md:min-w-md" @close="closeModal" wire:model="showModal">
        <div class="space-y-6">
            ...
            @if ($showVerificationStep)
                <div class="space-y-6">
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <x-mary-button class="btn-outline flex-1" wire:click="resetVerification">
                            {{ __('Back') }}
                        </x-mary-button>
                        ...
                        <x-mary-button class="btn-neutral dark:btn-secondary flex-1" wire:click="confirmTwoFactor"
                            x-bind:disabled="$wire.code.length < 6">
                            {{ __('Confirm') }}
                        </x-mary-button>
                    </div>
            ...
            <div>
                ...
                <x-mary-button class="btn-neutral dark:btn-secondary w-full"
                    wire:click="showVerificationIfNecessary" :disabled="$errors->has('setupData')">
                    {{ $this->modalConfig['buttonText'] }}
                </x-mary-button>
            </div>
